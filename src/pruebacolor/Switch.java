...
public class Switch extends JComponent implements MouseListener{
     ...
     */
    private final Color DISABLED_COMPONENT_COLOR = new Color(51,51,15);
    ...
    public Switch(){
        ...
        //colores iniciales
        Switch.this.setBackgroundColor(new Color(0,112,192)); 
    ...
    public void paintComponent(Graphics g){
        ...
        if(isEnabled()){//componente habilitado
            g2.setColor(( (OnOff) ? getBackgroundColor():new Color(121,165,197) ) );
