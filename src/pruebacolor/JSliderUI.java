...
public class JSliderUI extends BasicSliderUI {
    ...
    public JSliderUI(JSlider slider) {
        ...
        slider.setMaximum(255); // valor maximo del jslider
        slider.setMinimum(0);   // valor minimo del jslider
        slider.setValue(127);   // valor inicial
    ...
    protected Dimension getThumbSize() {
        return new Dimension(13, 13); // tamaño del circulo
    }
    ...
    private class PanelSlider extends JComponent {
        ...
        public PanelSlider(JSlider slider) {
            ...
            label = new JLabel("127"); // valor a mostrar en el label del jslider
